...
public class CreatePost implements Initializable {
    ...
    void onSave(ActionEvent event) throws IOException {
        ...
        if (title.getText().isEmpty() ||description.getText().isEmpty()  ) {
            ...
            alert.setContentText("Publication Posted Successfully.");
            DialogPane dialogPane = alert.getDialogPane();
            dialogPane.getStylesheets().add(getClass().getResource("/Style.css").toExternalForm());
            alert.showAndWait();

            FXMLLoader loader = new FXMLLoader(getClass().getResource("/AffichagePostFront.fxml"));
    ...
    void onCancel(ActionEvent event) throws IOException {
        ...
        FXMLLoader fxmlLoader = new FXMLLoader(MainFX.class.getResource("/AffichagePostFront.fxml"));
